...
import com.example.basic.global.security.service.CustomUserDetailService;
...
public class Oauth2AuthorizationConfig extends AuthorizationServerConfigurerAdapter {
    ...
    /*
     * /oauth/check_token 활성화 - ResourceServer 에서 사용
     */
    @Override
    ...
    /*
     * 클라이언트 정보 주입 방식을 jdbcDetail 로 변경
     */
    @Override
...
//                .accessTokenValiditySeconds(30000);
     ...
     */
    /*
     * Oauth2ResourceServer test 시 bearer token 활성화 시키기
     */
//    @Override
...
//    }
    ...
    /**
     * 토큰 발급 방식을 JWT 토큰 방식으로 변경한다. 이렇게 하면 토큰 저장하는 DB Table 은 필요가 없다.
     */
    @Override
