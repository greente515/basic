...
import com.example.basic.local.user.controller.UserController;
...
class UserControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post("/test/signin").params(params))
                .andDo(print())
    ...
    public void delete() throws Exception {
        Optional<User> user = userRepository.findByUid("happydaddy@naver.com");
        assertTrue(user.isPresent());
        mockMvc.perform(MockMvcRequestBuilders
                .delete("/test/user/" + user.get().getMsrl())
                .header("X-AUTH-TOKEN", token))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.success").value(true));
